...
// echo "where_con=$where_con<hr/>";
 $result=$obj->search('m_regform',$col_list,$where_con,$size,$pageno,"srch.php");
...
// <form action='srch.php' method='POST'>
// <div class='form-group row'>
// <label class='col-md-2'><h4><b>Select Size : </b></h4></label>
// <label class='col-md-3'><select name='size' class='form-control'>";
// for($i=1;$i<6;$i++){
//   if($i==$_SESSION['s'])
//     $st="selected";
//   else
